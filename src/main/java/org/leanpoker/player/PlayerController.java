...
public class PlayerController {
    ...
    @Consumes(MediaType.ALL)
    public String doPost(@QueryValue String action, @Nullable @QueryValue String game_state, HttpRequest<?> request)
        throws JsonProcessingException {
      log.info("request: {}", request.getParameters().get("game_state"));
